...
export interface DataStore extends AdminDao, AuditLogDao,DriverDao,DriverVehicleDao,DriverLicenseDao,LicensePlateDao,NotificationDao,ReportDao,ScanDao,UserDao,RoleDao,VehicleDao,VehicleHistoryDao,AuditLogDaoVehicle,ViolationDao {};
