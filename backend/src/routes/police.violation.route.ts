...
import { createVehicleTicket, getAllViolationTicket, getAllViolationTicketActions, searchForViolationsOnVehicle } from '../controller/police.vehcile.controller'
 ...
 * @access  Private (Police)
 **/
router.route('/').post(validatePoliceToken,uploadMultiFiles ,policeTicketValidation , validateRequest, createVehicleTicket)
 ...
 * @access  Private (Police)
 **/
router.route('/vehicle/:plate_id').get(validatePoliceToken, searchForViolationsOnVehicle)
